...
return array(
    ...
    // Zend\Validator\Uri
    "Invalid type given. String expected" => "Invalid type given. String expected",
    "The input does not appear to be a valid Uri" => "The input does not appear to be a valid Url",
    
    //Register not exist validation
    "Domain already exist. Try with another one" => "Domain already exist. Try with another one",
    "Organization name already exist. Try with another one" => "Organization name already exist. Try with another one",
    "Email already exist. Try with another one" => "Email already exist. Try with another one",
    ...
    "Please enter your Unique Id" => "Please enter your Unique Id",
    "Username already exists in database. Try with another one" => "Username already exists in database. Try with another one",
    "Id already exists in database. Try with another one" => "Id already exists in database. Try with another one",
    "This code already exists in database. Try with another one" => "This code already exists in database. Try with another one",
    "Please upload APK file" => "Please upload APK file",
    "Please enter package name" => "Please enter package name",
    "Please upload video file" => "Please upload video file",
);
